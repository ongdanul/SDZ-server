...
public class SecurityConstants {
    ...
    public static final int ACCESS_COOKIE_EXPIRATION = 60 * 60;  //1hours
    public static final int REFRESH_COOKIE_EXPIRATION = 7 * 24 * 60 * 60; //1week
    ...
    public static final String REMEMBER_ME_KEY = "security";
